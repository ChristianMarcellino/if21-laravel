                  ...
                  <form action="{{ route('jadwal.update', $jadwal->id)}}" method="POST">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <input id="nama" type="text" class="form-control" name="kelas" value="{{ old('kelas') ? old('kelas') : $jadwal->kelas }}">
                        @error('kelas')
                      ...
                      <div class="mb-3">
                        ...
                        <input id="tahun_akademik" type="text" class="form-control" name="tahun_akademik" value="{{ old('tahun_akademik') ? old('tahun_akademik') : $jadwal->tahun_akademik }}">
